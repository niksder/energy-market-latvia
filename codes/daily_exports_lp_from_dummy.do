...
cap mkdir "outputs/daily_exports_lp_war_dummy"
...
twoway ///
    ...
    ytitle("Response of electricity exports")

// Save the plot
graph export "outputs/daily_exports_lp_war_dummy/daily_irf_war_dummy.png", replace
...
twoway ///
    ...
    yline(0) ///
    xtitle("Days after war started (24 Feb 2022)") ///
    ytitle("Cumulative response of electricity exports")

// Save the plot
graph export "outputs/daily_exports_lp_war_dummy/daily_cumulative_irf_war_dummy.png", replace
