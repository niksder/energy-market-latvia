...
program define synth_did
    ...
    // Scale up GDP PPS for it to have bigger weight in the synth matching
    ...
    preserve
        ...
        twoway ///
            ...
            note("Synthetic control (Abadie et al. 2010).", size(vsmall)) ///
            scheme(s2color)
        graph export "outputs/panel/solar_diff_and_diff/synthetic/synth_path_fossil_share_`tag'_fix_dip.png", ///
            replace width(1400) height(900)
