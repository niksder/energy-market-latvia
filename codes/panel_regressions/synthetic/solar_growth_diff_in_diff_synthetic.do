...
program define synth_did
    ...
    preserve
        ...
        tempname fh_path
        file open `fh_path' using "outputs/panel/solar_diff_and_diff/synthetic/synth_path_solar_prod_`tag'.tex", write replace
        ...
        file close `fh_path'
        di as text "Real vs synthetic paths table saved: outputs/panel/solar_diff_and_diff/synthetic/synth_path_solar_prod_`tag'.tex"
    restore
