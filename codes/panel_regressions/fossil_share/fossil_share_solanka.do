...
//   β_k ≠ 0 for post-war periods → high-gas bzones changed fossil share differently
//
//   Period mapping:
...
preserve
    ...
    twoway ///
        ...
        ytitle("Coef (fossil share per pp of pre-war gas share)") ///
        title("Effect of Pre-War Gas Exposure on Fossil Share") ///
    ...
    graph export "outputs/panel/fossil_share/solanka/event_study_fossil_share.png", ///
...
file open `fh_tex' using ///
    "outputs/panel/fossil_share/solanka/event_study_fossil_share.tex", ///
    write replace

file write `fh_tex' "\begin{table}[htbp]" _n
file write `fh_tex' "\centering" _n
file write `fh_tex' "\caption{Event study: effect of pre-war gas exposure on fossil share}" _n
file write `fh_tex' "\label{tab:event_study_fossil_share_gas}" _n
...
di "LaTeX table saved to outputs/panel/fossil_share/solanka/event_study_fossil_share.tex"
