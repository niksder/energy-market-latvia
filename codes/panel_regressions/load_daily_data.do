...
drop if bzone == "Switzerland" // Not in EU 
...
collapse ///
    ...
    (mean) energy_price gas_share solar_share gas_prod_yearly solar_prod_yearly solar_prod_growth solar_share_growth total_generation_yearly ///
