...
program define synth_did
    ...
    preserve
        ...
        tempname fh_path
        file open `fh_path' using "outputs/panel/solar_diff_and_diff/on_fossil_share/synth_path_solar_share_`tag'.tex", write replace
        ...
        file close `fh_path'
        di as text "Real vs synthetic paths table saved: outputs/panel/solar_diff_and_diff/on_fossil_share/synth_path_solar_share_`tag'.tex"
    restore
