...
file open `fh_tex' using ///
    "outputs/panel/solar_diff_and_diff/solanka/event_study_solar_share.tex", ///
    write replace
...
file write `fh_tex' "Period & Gas share (treatment) & Other fossil (control) & Ln pop. density (control) \\" _n
...
di "LaTeX table saved to outputs/panel/solar_diff_and_diff/solanka/event_study_solar_share.tex"
