...
file open `fh_tex' using ///
    "outputs/panel/solar_diff_and_diff/solanka/event_study_solar_share_on_fossil.tex", ///
    write replace

file write `fh_tex' "\begin{table}[htbp]" _n
file write `fh_tex' "\centering" _n
file write `fh_tex' "\caption{Event study: effect of pre-war fossil exposure on solar share}" _n
file write `fh_tex' "\label{tab:event_study_solar_fossil}" _n
...
di "LaTeX table saved to outputs/panel/solar_diff_and_diff/solanka/event_study_solar_share_on_fossil.tex"
