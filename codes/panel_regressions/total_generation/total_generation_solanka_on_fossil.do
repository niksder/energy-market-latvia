...
//   β_k ≠ 0 for post-war periods → high-fossil bzones changed total generation differently
//
//   Period mapping:
...
preserve
    ...
    twoway ///
        ...
        ytitle("Coef (normalized total generation per pp of pre-war fossil share)") ///
        title("Effect of Pre-War Fossil Exposure on Total Generation") ///
    ...
    graph export "outputs/panel/total_generation/solanka/event_study_total_generation_on_fossil.png", ///
...
file open `fh_tex' using ///
    "outputs/panel/total_generation/solanka/event_study_total_generation_on_fossil.tex", ///
    write replace

file write `fh_tex' "\begin{table}[htbp]" _n
file write `fh_tex' "\centering" _n
file write `fh_tex' "\caption{Event study: effect of pre-war fossil exposure on total generation}" _n
file write `fh_tex' "\label{tab:event_study_total_gen_fossil}" _n
...
di "LaTeX table saved to outputs/panel/total_generation/solanka/event_study_total_generation_on_fossil.tex"
