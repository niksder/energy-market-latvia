...
program define synth_did
    ...
    preserve
        ...
        /* export delimited using ///
            "outputs/panel_countries/solar_diff_and_diff/on_fossil_share/synth_predictors_`tag'.csv", ///
            replace
        di as text "Predictor table saved: outputs/panel_countries/solar_diff_and_diff/on_fossil_share/synth_predictors_`tag'.csv" */
    restore
    ...
    preserve
        ...
        twoway ///
            ...
            scheme(s2color)
        graph export "outputs/panel_countries/solar_diff_and_diff/on_fossil_share/synth_path_solar_share_`tag'.png", ///
        ...
        twoway ///
            ...
            note("Synthetic control (Abadie et al. 2010).", size(vsmall)) ///
            scheme(s2color)
        graph export "outputs/panel_countries/solar_diff_and_diff/on_fossil_share/synth_path_fossil_share_`tag'.png", ///
            replace width(1400) height(900)
        ...
        tempname fh_path
        file open `fh_path' using "outputs/panel_countries/solar_diff_and_diff/on_fossil_share/synth_path_solar_share_`tag'.tex", write replace
        ...
        file close `fh_path'
        di as text "Real vs synthetic paths table saved: outputs/panel_countries/solar_diff_and_diff/on_fossil_share/synth_path_solar_share_`tag'.tex"
    restore
    ...
    di as text "Done [`tag']. Outputs in outputs/panel_countries/solar_diff_and_diff/on_fossil_share/"
end
...
di as text ""
di as text "All done. Outputs saved to outputs/panel_countries/solar_diff_and_diff/on_fossil_share/"
