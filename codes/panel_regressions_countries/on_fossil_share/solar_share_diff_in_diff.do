...
// Pre-war fossil share: value on Feb 23 2021 (fixed treatment intensity per country)
...
bysort country_id: egen fossil_share_pre = max(_tmp)
drop _tmp
...
di "Pre-war fossil share by country:"
table country, statistic(mean fossil_share_pre)
...
eststo did_levels
boottest c.fossil_share_pre#1.post, boottype(wild) cluster(country_id) reps(9999) seed(42) // Wild cluster bootstrap for robust inference with few clusters
...
//   β_k > 0 for post-war periods → high-fossil countries grew solar more
//
...
quietly summarize fossil_share_pre if country == "Latvia"
...
preserve
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/on_fossil_share/event_study_solar_share.png", ///
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/on_fossil_share/event_study_latvia_effect_solar_share.png", ///
        replace width(1400) height(900)
restore

di "Done. Outputs saved to outputs/panel_countries/solar_diff_and_diff/on_fossil_share/"
