...
table country, statistic(mean solar_share_pre_pct)
...
preserve
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/event_study_solar_growth.png", ///
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/event_study_latvia_effect_solar_growth.png", ///
        replace width(1400) height(900)
restore
