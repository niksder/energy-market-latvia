...
drop if country == "Switzerland" // Not in EU so missing Russian gas data
...
program define synth_did
    ...
    preserve
        ...
        order country is_treated solar_share energy_price_scaled population_density gdp_pps_scaled sun_scaled
        label var country              "Country / bidding zone"
        ...
        list country is_treated solar_share energy_price_scaled population_density gdp_pps_scaled sun_scaled, ///
            noobs sep(0) clean ab(26)
        /* export delimited using ///
            "outputs/panel_countries/solar_diff_and_diff/russia_dependence/synth_predictors_`tag'.csv", ///
            replace
        di as text "Predictor table saved: outputs/panel_countries/solar_diff_and_diff/russia_dependence/synth_predictors_`tag'.csv" */
    restore
    ...
    preserve
        ...
        twoway ///
            ...
            scheme(s2color)
        graph export "outputs/panel_countries/solar_diff_and_diff/russia_dependence/synth_path_solar_share_`tag'.png", ///
        ...
        twoway ///
            ...
            title("Latvia vs. synthetic: gas × Russia dependency (`hy_lbl' `yr')") ///
            subtitle("Red line = treatment start (`hy_lbl' `yr')") ///
            note("Synthetic control (Abadie et al. 2010).", size(vsmall)) ///
            scheme(s2color)
        graph export "outputs/panel_countries/solar_diff_and_diff/russia_dependence/synth_path_gas_russia_`tag'.png", ///
            replace width(1400) height(900)
        ...
        tempname fh_path
        file open `fh_path' using "outputs/panel_countries/solar_diff_and_diff/russia_dependence/synth_path_solar_share_`tag'.tex", write replace
        ...
        file write `fh_path' "\label{tab:synth_path_solar_share_`tag'}" _n
        ...
        file close `fh_path'
        di as text "Real vs synthetic paths table saved: outputs/panel_countries/solar_diff_and_diff/russia_dependence/synth_path_solar_share_`tag'.tex"
    restore
    ...
    preserve
        ...
        graph export "outputs/panel_countries/solar_diff_and_diff/russia_dependence/event_study_solar_share_`tag'.png", ///
            replace width(1400) height(900)
    restore

    di as text "Done [`tag']. Outputs in outputs/panel_countries/solar_diff_and_diff/russia_dependence/"
end
...
di as text ""
di as text "All done. Outputs saved to outputs/panel_countries/solar_diff_and_diff/russia_dependence/"
