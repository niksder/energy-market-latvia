...
drop if country == "Switzerland" // Drop Switzerland since it is not EU
// drop if country == "Ireland"
// drop if country == "Cyprus" // Drop Cyprus since it misses data from 2023 and 2024 and elsewhere
...
// Pre-war gas share: value on Feb 23 2021 (fixed treatment intensity per country)
...
// Pre-war solar share: value on Feb 23 2021 (baseline solar penetration per country)
...
eststo did_levels
boottest c.gas_share_pre#1.post, boottype(wild) cluster(country_id) reps(9999) seed(42) // Wild cluster bootstrap for robust inference with few clusters
...
quietly summarize gas_share_pre if country == "Latvia"
...
preserve
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/event_study_latvia_effect_solar_share.png", ///
        replace width(1400) height(900)
restore

di "Done. Outputs saved to outputs/panel_countries/solar_diff_and_diff/"
