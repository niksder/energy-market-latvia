...
table country, statistic(mean gas_share_pre_pct)
...
// D.ln_solar = ln_solar_t - ln_solar_{t-1} within each country
gen d_ln_solar = D.ln_solar
label var d_ln_solar "Daily log-diff of ln(solar_prod_yearly+1)"

// Drop first year of growth for countries whose solar data appears after the
...
bysort country_id: egen _solar_start = min(_first_solar)
drop _first_solar
...
quietly summarize gas_share_pre_pct if country == "Latvia"
...
preserve
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/account_for_fossils/event_study_solar_production_growth.png", ///
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/account_for_fossils/event_study_latvia_growth_rate.png", ///
        replace width(1400) height(900)
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/account_for_fossils/event_study_latvia_accumulated_effect.png", ///
        replace width(1400) height(900)
restore
