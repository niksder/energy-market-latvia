...
cap mkdir "outputs/panel_countries/solar_diff_and_diff/account_for_fossils"
...
bysort country_id: egen fossils_share_pre = max(_tmp3)
drop _tmp3
...
di "Pre-war fossils share by country:"
table country, statistic(mean fossils_share_pre)
...
preserve
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/account_for_fossils/event_study_solar_share.png", ///
    ...
    graph export "outputs/panel_countries/solar_diff_and_diff/account_for_fossils/event_study_latvia_effect_solar_share.png", ///
        replace width(1400) height(900)
restore

di "Done. Outputs saved to outputs/panel_countries/solar_diff_and_diff/account_for_fossils/"
