...
program define synth_did
    ...
    bysort country_id: egen _n_miss_pre = total(missing(d_ln_solar) & hy_seq_pos <= `pre_end')
    ...
    preserve
        ...
        order country is_treated d_ln_solar energy_price_scaled population_density gdp_pps_scaled sun_scaled
        ...
        list country is_treated d_ln_solar energy_price_scaled population_density gdp_pps_scaled sun_scaled, ///
    ...
    preserve
        ...
        twoway ///
            ...
            scheme(s2color)
        graph export "outputs/panel_countries/solar_diff_and_diff/synthetic/synth_path_solar_prod_`tag'.png", ///
