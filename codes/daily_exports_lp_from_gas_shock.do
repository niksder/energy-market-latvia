...
// Create daily_exports_lp directory ONLY if it doesn't exist
cap mkdir "outputs/daily_exports_lp"
...
gen d_energy_exports = D.electricity_exports

forvalues h = 0/`H' {

    regress F`h'.d_energy_exports ///
        gas_resid_daily ///
        L(1/7).d_energy_exports ///
...
// Save the plot
graph export "outputs/daily_exports_lp/daily_irf_gas_shock.png", replace
...
// Save the plot
graph export "outputs/daily_exports_lp/daily_cumulative_irf_gas_shock.png", replace
...
// Save the plot
graph export "outputs/daily_exports_lp/daily_irf_invasion_shock.png", replace
...
// Save the plot
graph export "outputs/daily_exports_lp/daily_cumulative_irf_invasion_shock.png", replace
...
graph export "outputs/daily_exports_lp/daily_irf_invasion_full.png", replace
...
graph export "outputs/daily_exports_lp/daily_cumulative_irf_invasion_full.png", replace
