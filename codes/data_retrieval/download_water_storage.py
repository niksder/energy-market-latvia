...
# Download water storage data from ENTSOE API and save to CSV file

def download_water_storage(year=2026):
    ...
    if response.status_code == 200:
        ...
        print(f'Water storage data for {year} downloaded successfully and saved to {file_path}')
    else:
        print(f'Failed to download water storage data for {year}. Status code: {response.status_code}')
